...
/*
    ...
    Calculate the Heat Index with the temperature and the humidity

    Return: value of the Heat Index
*/
/**************************************************************************/
...
/*
    ...
    Calculate the dewpoint with the temperature and the humidity

    Return: value of the dewpoint
*/
/**************************************************************************/
float AHT10::calculateDewPoint(float temperature, float humidity) {
    // Constantes para la fórmula
    const float A = 17.27;
    const float B = 237.7; // en grados Celsius

    // Calcular el valor intermedio gamma
...
/*
    ...
    Get all the data of the AHT10 sensor

    Return: value of the temperature, humidity, heatIndex, dewPoint
*/
/**************************************************************************/
void AHT10::getAHT10Data(float* temp, float* hum, float* heatIndex, float* dewPoint){
